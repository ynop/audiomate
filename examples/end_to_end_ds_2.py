...
#   Train
#
train_set = feeding.FrameDataset(train_corpus, [train_feats, train_targets])
train_loader = data.DataLoader(train_set, batch_size=BATCH_SIZE, num_workers=1, shuffle=True, pin_memory=True)

dev_set = feeding.FrameDataset(dev_corpus, [dev_feats, dev_targets])
dev_loader = data.DataLoader(dev_set, batch_size=BATCH_SIZE, num_workers=1, shuffle=True, pin_memory=True)

test_set = feeding.FrameDataset(test_corpus, [test_feats, test_targets])
test_loader = data.DataLoader(test_set, batch_size=BATCH_SIZE, num_workers=1, shuffle=True, pin_memory=True)
