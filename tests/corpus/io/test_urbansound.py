...
class TestUrbansound8kReader:
    ...
    def test_load_tracks(self, reader, data_path):
        ...
        assert ds.tracks['100032-3-0-0'].idx == '100032-3-0-0'
        assert ds.tracks['100032-3-0-0'].path == os.path.join(data_path, 'audio', 'fold5', '100032-3-0-0.wav')

        assert ds.tracks['100263-2-0-117'].idx == '100263-2-0-117'
        assert ds.tracks['100263-2-0-117'].path == os.path.join(data_path, 'audio', 'fold5', '100263-2-0-117.wav')

        assert ds.tracks['145612-6-3-0'].idx == '145612-6-3-0'
        assert ds.tracks['145612-6-3-0'].path == os.path.join(data_path, 'audio', 'fold8', '145612-6-3-0.wav')

        assert ds.tracks['145683-6-5-0'].idx == '145683-6-5-0'
        assert ds.tracks['145683-6-5-0'].path == os.path.join(data_path, 'audio', 'fold9', '145683-6-5-0.wav')

        assert ds.tracks['79377-9-0-4'].idx == '79377-9-0-4'
        assert ds.tracks['79377-9-0-4'].path == os.path.join(data_path, 'audio', 'fold2', '79377-9-0-4.wav')
    ...
    def test_load_labels(self, reader, data_path):
        ...
        assert ds.utterances['100032-3-0-0'].label_lists[corpus.LL_SOUND_CLASS][0].end == float('inf')
        ...
        assert ds.utterances['100263-2-0-117'].label_lists[corpus.LL_SOUND_CLASS][0].end == float('inf')
        ...
        assert ds.utterances['145612-6-3-0'].label_lists[corpus.LL_SOUND_CLASS][0].end == float('inf')
        ...
        assert ds.utterances['145683-6-5-0'].label_lists[corpus.LL_SOUND_CLASS][0].end == float('inf')
        ...
        assert ds.utterances['79377-9-0-4'].label_lists[corpus.LL_SOUND_CLASS][0].end == float('inf')
