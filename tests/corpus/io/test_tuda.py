...
class TestTudaReader:
    ...
    def test_load_speakers(self, reader, data_path):
        ...
        assert ds.issuers['cf372280-5606-4b05-9d24-3ab7805d8462'].info['gender'] == 'male'

        assert ds.issuers['55065c47-1290-4974-997e-e77f24e7c72d'].idx == '55065c47-1290-4974-997e-e77f24e7c72d'
        assert ds.issuers['55065c47-1290-4974-997e-e77f24e7c72d'].info['gender'] == 'male'
        ...
        assert ds.issuers['9e6a00c9-80f0-479d-8b36-4139a9571217'].info['gender'] == 'female'

        assert ds.issuers['58b8b441-684f-4753-aa16-589f1e149fa0'].idx == '58b8b441-684f-4753-aa16-589f1e149fa0'
        assert ds.issuers['58b8b441-684f-4753-aa16-589f1e149fa0'].info['gender'] == 'female'
