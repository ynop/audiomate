...
class TestESC50Reader:
    ...
    def test_load_tracks(self, reader, data_path):
        ...
        assert ds.tracks['1-119125-A-45'].idx == '1-119125-A-45'
        assert ds.tracks['1-119125-A-45'].path == os.path.join(data_path, 'audio', '1-119125-A-45.wav')

        assert ds.tracks['1-12654-B-15'].idx == '1-12654-B-15'
        assert ds.tracks['1-12654-B-15'].path == os.path.join(data_path, 'audio', '1-12654-B-15.wav')

        assert ds.tracks['1-155858-E-25'].idx == '1-155858-E-25'
        assert ds.tracks['1-155858-E-25'].path == os.path.join(data_path, 'audio', '1-155858-E-25.wav')

        assert ds.tracks['1-155858-F-25'].idx == '1-155858-F-25'
        assert ds.tracks['1-155858-F-25'].path == os.path.join(data_path, 'audio', '1-155858-F-25.wav')

        assert ds.tracks['1-15689-A-4'].idx == '1-15689-A-4'
        assert ds.tracks['1-15689-A-4'].path == os.path.join(data_path, 'audio', '1-15689-A-4.wav')

        assert ds.tracks['1-17124-A-43'].idx == '1-17124-A-43'
        assert ds.tracks['1-17124-A-43'].path == os.path.join(data_path, 'audio', '1-17124-A-43.wav')

        assert ds.tracks['1-18755-A-4'].idx == '1-18755-A-4'
        assert ds.tracks['1-18755-A-4'].path == os.path.join(data_path, 'audio', '1-18755-A-4.wav')

        assert ds.tracks['1-18755-B-4'].idx == '1-18755-B-4'
        assert ds.tracks['1-18755-B-4'].path == os.path.join(data_path, 'audio', '1-18755-B-4.wav')

        assert ds.tracks['1-18757-A-4'].idx == '1-18757-A-4'
        assert ds.tracks['1-18757-A-4'].path == os.path.join(data_path, 'audio', '1-18757-A-4.wav')

        assert ds.tracks['1-18810-A-49'].idx == '1-18810-A-49'
        assert ds.tracks['1-18810-A-49'].path == os.path.join(data_path, 'audio', '1-18810-A-49.wav')
    ...
    def test_load_utterances(self, reader, data_path):
        ...
        assert ds.utterances['1-119125-A-45'].track.idx == '1-119125-A-45'
        ...
        assert ds.utterances['1-12654-B-15'].track.idx == '1-12654-B-15'
        ...
        assert ds.utterances['1-155858-E-25'].track.idx == '1-155858-E-25'
        ...
        assert ds.utterances['1-155858-F-25'].track.idx == '1-155858-F-25'
        ...
        assert ds.utterances['1-15689-A-4'].track.idx == '1-15689-A-4'
        ...
        assert ds.utterances['1-17124-A-43'].track.idx == '1-17124-A-43'
        ...
        assert ds.utterances['1-18755-A-4'].track.idx == '1-18755-A-4'
        ...
        assert ds.utterances['1-18755-B-4'].track.idx == '1-18755-B-4'
        ...
        assert ds.utterances['1-18757-A-4'].track.idx == '1-18757-A-4'
        ...
        assert ds.utterances['1-18810-A-49'].track.idx == '1-18810-A-49'
    ...
    def test_load_labels(self, reader, data_path):
        ...
        assert ds.utterances['1-119125-A-45'].label_lists[corpus.LL_SOUND_CLASS].labels[0].value == 'train'
        assert ds.utterances['1-119125-A-45'].label_lists[corpus.LL_SOUND_CLASS].labels[0].start == 0
        assert ds.utterances['1-119125-A-45'].label_lists[corpus.LL_SOUND_CLASS].labels[0].end == -1

        assert ds.utterances['1-15689-A-4'].label_lists[corpus.LL_SOUND_CLASS].labels[0].value == 'frog'
        assert ds.utterances['1-15689-A-4'].label_lists[corpus.LL_SOUND_CLASS].labels[0].start == 0
        assert ds.utterances['1-15689-A-4'].label_lists[corpus.LL_SOUND_CLASS].labels[0].end == -1

        assert ds.utterances['1-18810-A-49'].label_lists[corpus.LL_SOUND_CLASS].labels[0].value == 'hand_saw'
        assert ds.utterances['1-18810-A-49'].label_lists[corpus.LL_SOUND_CLASS].labels[0].start == 0
        assert ds.utterances['1-18810-A-49'].label_lists[corpus.LL_SOUND_CLASS].labels[0].end == -1
